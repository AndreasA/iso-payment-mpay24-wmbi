 ...
 * fields
 */
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_merchant_id"]	= array("Merchant ID", "Geben Sie ihre Merchant ID bei mPay24 an.");
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_merchant_test_id"]	= array("Merchant ID (Test-System)", "Geben Sie ihre Merchant ID für das Testsystem bei mPay24 an.");
...
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_billed_order_status"] = array('Status nach erfolgreicher Abbuchung/Bezahlung', '');
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_failed_order_status"] = array('Status bei fehlgeschlagener Bezahlung', '');
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_canceled_order_status"] = array('Status bei stornierung der Bestellung/Zahlung', '');
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_test_authorized_ip"] = array('mPay24 Test-System IP-Adresse benötigt/verwendet für PostSale', '');
$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_prod_authorized_ip"] = array('mPay24 Live-System IP-Adresse benötigt/verwendet für PostSale', '');
