...
$GLOBALS["TL_DCA"]["tl_iso_payment_modules"]["fields"]["mpay24_wmbi_test_authorized_ip"] = array(
    "label"						=> &$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_test_authorized_ip"],
    "default"					=> "213.164.23.169",
    "exclude"					=> true,
    "inputType"					=> "text",
    "eval"						=> array("mandatory" => false, "tl_class" => "w50")
);
...
$GLOBALS["TL_DCA"]["tl_iso_payment_modules"]["fields"]["mpay24_wmbi_prod_authorized_ip"] = array(
    "label"						=> &$GLOBALS["TL_LANG"]["tl_iso_payment_modules"]["mpay24_wmbi_prod_authorized_ip"],
    "default"					=> "213.164.25.245",
    "exclude"					=> true,
    "inputType"					=> "text",
